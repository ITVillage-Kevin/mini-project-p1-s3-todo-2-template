...
public class GoogleTasksInitializer {
    ...
    public static Tasks initialize() throws GeneralSecurityException, IOException {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = GoogleTasksRepository.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
