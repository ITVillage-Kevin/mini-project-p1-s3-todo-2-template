...
@DisplayName("Google Tasks API 샘플 테스트")
public class TasksQuickstartTest {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = TasksQuickstartTest.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    @Test
    public void sampleTest() throws IOException, GeneralSecurityException{
